      ...
      <div className="mx-auto w-full max-w-6xl space-y-4">
        ...
        <header className="relative pt-1 pb-2">
          <div className="mx-auto flex max-w-xl flex-col items-center justify-center text-center">
            <h1 className="font-title text-[1.85rem] text-gold sm:text-[2rem]">Tableau admin</h1>
            <p className="text-[0.95rem] text-foreground-secondary sm:text-base">Demandes reçues via le site.</p>
          </div>
        </header>
        <AdminLeadsSections leads={leads} />

        <div className="flex items-center justify-center gap-4 pt-2 text-foreground-muted">
